...
def detect_query(state: State):
    ...
    # OpenAI Call
    result = client.beta.chat.completions.parse(model="gpt-4o-mini", response_format=DetectCallResponse,
        messages=[
...
def solve_coding_question(state: State):
    ...
    SYSTEM_PROMPT = """
        You are an AI assistant. Your job is to resolve the user query based on coding problem user is facing.
        """
...
def call_graph():
    state = {
        "user_message": "How to use LangGraph?",
        "ai_message": "",
